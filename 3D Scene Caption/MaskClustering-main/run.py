...
def get_seq_name_list(dataset):
    if dataset == 'scannet':
        ...
        file_path = 'data/scannetpp/splits/scannetpp.txt'
...
def main(args):
    ...
    #according to the preprocessing guide
    cropformer_path = "/home/vlm_caption/VLM_Caption/MaskClustering-main/third_party/Mask2Former_hornet_3x_576d0b.pth"
    ...
    cmd = (
    f'python third_party/detectron2/projects/CropFormer/demo_cropformer/mask_predict.py '
    f'--config-file third_party/detectron2/projects/CropFormer/configs/entityv2/entity_segmentation/mask2former_swin_tiny_3x.yaml '
    f'--root {root} --image_path_pattern {image_path_pattern} '
    f'--dataset {args.dataset} --seq_name_list {seq_name} '
    f'--opts MODEL.WEIGHTS {cropformer_path}'
    )

    print("Start Cropformer")
    os.system(cmd)
        
    print("Finish Cropformer")
    """
